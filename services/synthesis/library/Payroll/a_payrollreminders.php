...
/**
* a_PayrollReminders
* Cron-triggered: Check to see if it's time to run payroll, pay payroll taxes, or file payroll tax reports, 
* and if so, send an email reminder to the administrator with the link to trigger each appropriate action.
*
...
* @license proprietary
*/
class a_PayrollReminders extends Action
{
