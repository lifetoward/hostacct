...
class safehtml {
  ...
  // GuyJohnson added the a tag (for anchors) 20110618
  ...
  var $Attributes = array("dynsrc", "id", ); // removed name attribute from this blackList to allow anchors: GuyJohnson 20110618
